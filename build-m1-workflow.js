...
return { json: { textQuery: t.textQuery, maxResultCount: 5, businessType: t.businessType, city: t.city } };` },
    ...
    { parameters: { url: '={{ $json.website }}', sendHeaders: true, headerParameters: { parameters: [{ name: 'User-Agent', value: 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0 Safari/537.36' }] }, options: { response: { response: { responseFormat: 'text' } }, timeout: 20000 } },
    ...
    { parameters: { url: '={{ $json.aboutUrl }}', sendHeaders: true, headerParameters: { parameters: [{ name: 'User-Agent', value: 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0 Safari/537.36' }] }, options: { response: { response: { responseFormat: 'text' } }, timeout: 20000 } },
